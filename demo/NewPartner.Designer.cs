namespace demo
{
	partial class NewPartner
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnSavePartner.Text = "Сохранить";
			...
			this.panel2.Size = new System.Drawing.Size(1219, 106);
			...
			this.groupBox1.Controls.Add(this.cbTypePartnerName);
			this.groupBox1.Controls.Add(this.numRating);
			this.groupBox1.Controls.Add(this.txtAddress);
			this.groupBox1.Controls.Add(this.txtPhonePartner);
			this.groupBox1.Controls.Add(this.txtEmail);
			this.groupBox1.Controls.Add(this.txtDirector);
			this.groupBox1.Controls.Add(this.txtNamePartner);
			this.groupBox1.Controls.Add(this.txtInn);
			this.groupBox1.Location = new System.Drawing.Point(12, 116);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.Size = new System.Drawing.Size(512, 388);
			...
			this.label2.Text = "Название партнера";
			// 
			// label8
			// 
			this.label8.AutoSize = true;
			this.label8.Location = new System.Drawing.Point(317, 300);
			...
			this.cbTypePartnerName.Location = new System.Drawing.Point(12, 37);
			this.cbTypePartnerName.Name = "cbTypePartnerName";
			this.cbTypePartnerName.Size = new System.Drawing.Size(121, 21);
			this.cbTypePartnerName.TabIndex = 11;
			// 
			// numRating
			// 
			this.numRating.Location = new System.Drawing.Point(320, 330);
			this.numRating.Name = "numRating";
			this.numRating.Size = new System.Drawing.Size(161, 20);
			this.numRating.TabIndex = 23;
			// 
			// txtAddress
			// 
			this.txtAddress.Location = new System.Drawing.Point(12, 204);
			...
			// txtPhonePartner
			// 
			this.txtPhonePartner.Location = new System.Drawing.Point(12, 152);
			this.txtPhonePartner.MaxLength = 20;
			this.txtPhonePartner.Name = "txtPhonePartner";
			this.txtPhonePartner.Size = new System.Drawing.Size(469, 20);
			this.txtPhonePartner.TabIndex = 10;
			this.txtPhonePartner.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.keyPress);
			// 
			// txtEmail
			// 
			...
			// txtDirector
			// 
			this.txtDirector.Location = new System.Drawing.Point(12, 90);
			...
			// txtNamePartner
			// 
			this.txtNamePartner.Location = new System.Drawing.Point(164, 37);
			this.txtNamePartner.Name = "txtNamePartner";
			this.txtNamePartner.Size = new System.Drawing.Size(317, 20);
			this.txtNamePartner.TabIndex = 8;
			// 
			// txtInn
			// 
			this.txtInn.Location = new System.Drawing.Point(12, 330);
			this.txtInn.Name = "txtInn";
			this.txtInn.Size = new System.Drawing.Size(208, 20);
			this.txtInn.TabIndex = 22;
			this.txtInn.Text = " ";
			// 
			// button2
			// 
			...
			this.Text = "Информация о партнере";
